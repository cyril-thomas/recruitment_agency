...
class PostToAPIToolInput(BaseModel):
    ...
    data: dict = Field(..., description="The data dictionary to be sent in the request body.")
...
class PostToAPITool(BaseTool):
    ...
    headers: Optional[dict] = Field(..., description="Additional headers to include in the request")
